...
void Surface::PrintCenter(char* t, int y1, uint c)
{
	int x = (width - (int)strlen(t) * 6) / 2;
	Print(t, x, y1, c);
}
...
void Surface::InitCharset()
{
	...
	SetChar(50, ":::::", "::o::", ":::::", "::o::", ":o:::");
	SetChar(51, ":ooo:", ":o:::", ":o:::", ":o:::", ":ooo:");
	SetChar(52, ":ooo:", ":::o:", ":::o:", ":::o:", ":ooo:");
	SetChar(53, ":oo::", ":o:::", "oo:::", ":o:::", ":oo::");
	SetChar(54, "::oo:", ":::o:", ":::oo", ":::o:", "::oo:");
	SetChar(55, "::o::", "::o::", "ooooo", "::o::", "::o::");
	SetChar(56, ":::::", ":::::", ":::::", ":::::", "ooooo");

	char c[] = "abcdefghijklmnopqrstuvwxyz0123456789!?:=,.-() #'*/;[]{}+_";
	int i;
	for (i = 0; i < 256; i++) transl[i] = 45;
	for (i = 0; i < 57; i++) transl[(unsigned char)c[i]] = i;
}