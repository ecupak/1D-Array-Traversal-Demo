...
void main()
{
...
#else
	window = glfwCreateWindow( SCREENWIDTH, SCREENHEIGHT, "Tmpl8-2023", 0, 0 );
#endif
	...
	InitRenderTarget( SCREENWIDTH, SCREENHEIGHT );
	Surface* screen = new Surface( SCREENWIDTH, SCREENHEIGHT );
	app = new Game();
	app->screen = screen;
	app->Init();
